...
@section('title', 'Тест ввода телефона')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3>Тест ввода номера телефона</h3>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="text" class="form-control"
                                           id="country_code_input" name="country_code" value="+375"
                                           placeholder="+375" style="max-width: 80px;" readonly>
                                    <input type="tel" class="form-control"
                                           id="phone" name="phone" placeholder="(29) 123-45-67" maxlength="20">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label">Текущие цифры (отладка):</label>
                        <input type="text" class="form-control" id="debug-digits" readonly>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Сырой ввод (отладка):</label>
                        <input type="text" class="form-control" id="debug-raw" readonly>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    phoneInput.addEventListener('input', function(e) {
        ...
        debugRaw.value = this.value;
        debugDigits.value = digits;
            ...
            if (digits.length === 0) {
                ...
                if (digits.length >= 3) {
                    ...
                    if (remaining.length <= 3) {
                        ...
                        formatted += ' ' + remaining.slice(0, 3) + '-' + remaining.slice(3, 2) + '-' + remaining.slice(5);
                    }
                }
            }
        } else if (countryCode === '+7') {
